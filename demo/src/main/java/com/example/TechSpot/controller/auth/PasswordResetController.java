...
import com.example.TechSpot.service.user.password.PasswordResetService;
...
@Tag(
		...
		description = "API для восстановления пароля - отправка кода и сброс пароля"
)
@Schema(description = "Контроллер для восстановления доступа к аккаунту через сброс пароля")
