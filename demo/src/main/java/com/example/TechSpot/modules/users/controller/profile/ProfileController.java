package com.example.TechSpot.modules.users.controller.profile;
...
import com.example.TechSpot.modules.users.service.command.ProfileService;
...
@Tag(name = "Profile", description = "API для управления профилем пользователя - получение и обновление данных профиля")
