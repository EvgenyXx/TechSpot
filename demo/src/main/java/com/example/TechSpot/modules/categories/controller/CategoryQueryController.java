package com.example.TechSpot.modules.categories.controller;

import com.example.TechSpot.common.constants.ApiPaths;
import com.example.TechSpot.modules.categories.dto.CategoryResponse;
import com.example.TechSpot.modules.categories.service.query.CategoryQueryService;
...
@Tag(name = "Categories", description = "API для получения категорий товаров")
