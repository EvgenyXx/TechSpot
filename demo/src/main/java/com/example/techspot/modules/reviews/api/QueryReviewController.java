...
import com.example.techspot.modules.reviews.application.query.ReviewQueryService;
...
public class QueryReviewController {
	...
	public ResponseEntity<List<ReviewResponse>> getProductReviews(
		...
		List<ReviewResponse> response = reviewQueryService.getProductReviews(productId,userDetail.id());
